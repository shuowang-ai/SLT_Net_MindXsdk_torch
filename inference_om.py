...
parser.add_argument('--onnx_path', type=str, default='/Users/mac/Downloads/sltnet.onnx')

parser.add_argument('--save_root', type=str, default='/home/fandengping01/shuowang_project/sltnet_res_torch/')
parser.add_argument('--om_path', type=str, default='/home/fandengping01/shuowang_project/om_model/sltnet.om')
